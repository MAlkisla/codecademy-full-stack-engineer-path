...
// Testing the functions with provided test cases
console.log(validateCred(valid1)); // Should return true
console.log(validateCred(invalid1)); // Should return false
console.log(findInvalidCards([valid1, valid2, invalid1])); // Should return [invalid1]
const invalidCards = findInvalidCards([valid1, valid2, invalid1, invalid2]);
console.log(idInvalidCardCompanies(invalidCards)); // Should return ['Visa', 'Mastercard']
